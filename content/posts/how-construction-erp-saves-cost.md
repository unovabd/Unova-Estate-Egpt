...
One of the most common leakages is store material diversion. When steel, cement, or sand is issued from the central store, it is often not reconciled with the physical structure's estimated usage. An ERP automates this by comparing actual consumption against the original Bill of Quantities (BOQ).
